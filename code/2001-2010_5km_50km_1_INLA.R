...
attach(mtcars)
par(mfrow=c(1,3))
plot(year, accuracy, main="50km Radius, Presence 1", 
     xlab="Year ", ylab="Total Accuracy", pch=19)
plot(year, accuracypos, main="50km Radius, Presence 1", 
     xlab="Year ", ylab="True Positive", pch=19)
plot(year, falsepos, main="50km Radius, Presence 1", 
...
writeRaster(x=psi.pred.raster11, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2011_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

psi.pred.raster12<-raster(matrix(preds2$psi, nrow(theta12), ncol(theta12), byrow=T), crs=proj4string(theta12))
writeRaster(x=psi.pred.raster12, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2012_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

psi.pred.raster13<-raster(matrix(preds3$psi, nrow(theta13), ncol(theta13), byrow=T), crs=proj4string(theta13))
writeRaster(x=psi.pred.raster13, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2013_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

psi.pred.raster14<-raster(matrix(preds4$psi, nrow(theta14), ncol(theta14), byrow=T), crs=proj4string(theta14))
writeRaster(x=psi.pred.raster14, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2014_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

psi.pred.raster15<-raster(matrix(preds5$psi, nrow(theta15), ncol(theta15), byrow=T), crs=proj4string(theta15))
writeRaster(x=psi.pred.raster15, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2015_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

psi.pred.raster16<-raster(matrix(preds6$psi, nrow(theta16), ncol(theta16), byrow=T), crs=proj4string(theta16))
writeRaster(x=psi.pred.raster16, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2016_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

psi.pred.raster17<-raster(matrix(preds7$psi, nrow(theta17), ncol(theta17), byrow=T), crs=proj4string(theta17))
writeRaster(x=psi.pred.raster17, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2017_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

psi.pred.raster18<-raster(matrix(preds8$psi, nrow(theta18), ncol(theta18), byrow=T), crs=proj4string(theta18))
writeRaster(x=psi.pred.raster18, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2018_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

psi.pred.raster19<-raster(matrix(preds9$psi, nrow(theta19), ncol(theta19), byrow=T), crs=proj4string(theta19))
writeRaster(x=psi.pred.raster19, filename=here("./Data/Reduced/2001_2010_5km_50km_1_2019_INLA.tif"), 
            format="GTiff", overwrite=TRUE)

## Plots!!
par(mfrow = c(3, 2))
plot(psi.pred.raster11, main="50km, 1, predictions 2011")
plot(theta11, main="50km, 1, actual 2011")

plot(psi.pred.raster12, main="50km, 1, predictions 2012")
plot(theta12, main="50km, 1, actual 2012")

plot(psi.pred.raster13, main="50km, 1, predictions 2013")
plot(theta13, main="50km, 1, actual 2013")

plot(psi.pred.raster14, main="50km, 1, predictions 2014")
plot(theta14, main="50km, 1, actual 2014")

plot(psi.pred.raster15, main="50km, 1, predictions 2015")
plot(theta15, main="50km, 1, actual 2015")

plot(psi.pred.raster16, main="50km, 1, predictions 2016")
plot(theta16, main="50km, 1, actual 2016")

plot(psi.pred.raster17, main="50km, 1, predictions 2017")
plot(theta17, main="50km, 1, actual 2017")

plot(psi.pred.raster18, main="50km, 1, predictions 2018")
plot(theta18, main="50km, 1, actual 2018")

plot(psi.pred.raster19, main="50km, 1, predictions 2019")
plot(theta19, main="50km, 1, actual 2019")
...
saveRDS(toSave, here("Data/Model Predictions/2001-2010_5km_50km_1_INLA.RDS"))
